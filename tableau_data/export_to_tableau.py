    ...
    pipeline = [
        ...
        },
        {
            '$group': {
                ...
                'number_of_persons_injured': {'$sum': {'$toInt': '$number_of_persons_injured'}},
                'number_of_persons_killed': {'$sum': {'$toInt': '$number_of_persons_killed'}},
    ...
    pipeline = [
        ...
        },
        {
            '$group': {
                ...
                'incident_count': {'$sum': 1},
                'total_injured': {'$sum': {'$toInt': '$number_of_persons_injured'}}
            }
        }
    ]
    ...
    pipeline = [
        ...
        },
        {
            '$group': {
                ...
                'total_injured': {'$sum': {'$toInt': '$number_of_persons_injured'}},
                'total_killed': {'$sum': {'$toInt': '$number_of_persons_killed'}}
            }
        },
        {
